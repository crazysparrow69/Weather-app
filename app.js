...
const weather = {
  ...
  selectedCity: function () {
    return this.DOM.select.querySelectorAll("option")[
      this.DOM.select.selectedIndex
    ].value;
  },
  ...
  getDate: function () {
    ...
    return `${date.hours}:${date.minutes} - ${date.day} ${
      months[date.month]
    }, ${date.weekDay}`;
  },
  ...
  showWeather: function (indicators) {
    ...
    this.DOM.title.img.src = "/img/weather/clouds.jpg";
